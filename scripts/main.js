...
function teclaNumerica(valorTecla) {
...
function pontoFlutuante(valorTecla) {
    //Reseta o display histórico se hover algum aviso nele.
    if (historico.innerHTML === "Digite um número primeiro") {
        historico.innerHTML = ""
    }
...
function teclaOperacoes(valorTecla) {
...
function teclaIgual(valorTecla) {
...
function teclaBackspace(valorTecla) {
...
function teclaAlternarSinal(valorTecla) {
...
function calculadora(event) {
    ...
    if (valorTecla === "⌫")
        teclaBackspace(valorTecla)

    if (valorTecla === "+/-")
        teclaAlternarSinal(valorTecla)
...
botoes.forEach(botao => botao.onclick = calculadora)